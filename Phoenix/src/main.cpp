...
void BoostGeometryDemo()
{
    ...
    //Library lib = LoadGDS("C:/Users/PC/Desktop/poc/fichiers_gdsii/simple.gds");
...
void Clipper2Demo()
{
    ...
    Library lib = GdstkUtils::LoadGDS("C:/Users/PC/Desktop/poc/fichiers_gdsii/Image Primaire V2.gds");
    //Library lib = LoadGDS("C:/Users/PC/Desktop/poc/fichiers_gdsii/0 - Image Solder PHC.gds");
    //Library lib = LoadGDS("C:/Users/PC/Desktop/poc/fichiers_gdsii/0 - Image Legend PHC.gds",);
    //Library lib = LoadGDS("C:/Users/PC/Desktop/poc/fichiers_gdsii/0 - Percage PHC SUP 250.gds");
    //Library lib = LoadGDS("C:/Users/PC/Desktop/poc/fichiers_gdsii/simple.gds");
    //Library lib = LoadGDS("C:/Users/PC/Desktop/poc/fichiers_gdsii/square.gds");
    ...
    Clipper2Utils::MakeTriangulation(u, clipper2_lib);
    std::vector<Library> clipper2_layers = { clipper2_lib };
    Utils::WriteLibraryToObj(clipper2_layers, (root_path + "triangulation_full_clipper2.obj").c_str());
    ...
    Utils::WriteLayersObj(tris, (root_path + "triangulation_layers.obj").c_str());
